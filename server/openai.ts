...
Keep responses under 150 words unless a detailed explanation is necessary.`
    ...
    log(`Sending request to chat API: ${message}`, "chat-api");
    
    // Create a simple rule-based response generator
    // This avoids API key requirements for demonstration purposes
    const keywords = {
    ...
    log(`Error generating response: ${error.message}`, "chat-api");
